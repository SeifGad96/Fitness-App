...
fun Calculator(modifier: Modifier = Modifier, navController: NavController, authViewModel: AuthViewModel) {
    ...
    val genderSelectState = remember { mutableStateOf(1) }
    ...
    Surface(color = Color(9, 12, 34, 1)) {
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Row {
                HeightAndAge(text = "WEIGHT", value = weightSelectState, color = Color.White)
                HeightAndAge(text = "AGE", value = ageSelectState, color = Color.White)
            }
...
//@Composable
//fun showCalculator() {
//    Calculator(navController = rememberNavController(), authViewModel = AuthViewModel())
//}
...
//                    text = "Male",
//                    icon = Icons.Default.Male,
//                    color = if (genderSelectState.value == 1) MaterialTheme.colorScheme.onPrimary else MaterialTheme.colorScheme.onSurface.copy(alpha = 0.5f),
//                    onClick = { genderSelectState.value = 1 }
//                )
//                Spacer(modifier = Modifier.width(5.dp))
//                GenderBox(
//                    text = "Female",
//                    icon = Icons.Default.Female,
//                    color = if (genderSelectState.value == 2) MaterialTheme.colorScheme.onPrimary else MaterialTheme.colorScheme.onSurface.copy(alpha = 0.5f),
//                    onClick = { genderSelectState.value = 2 }
//                )
//            }
//
...
//                HeightAndAge(
//                    text = "WEIGHT",
//                    value = weightSelectState,
//                    color = MaterialTheme.colorScheme.surface
//                )
//                HeightAndAge(
//                    text = "AGE",
//                    value = ageSelectState,
//                    color = MaterialTheme.colorScheme.surface
//                )
//            }
//
...
//                    val age = ageSelectState.value
//                    val bmi = (weight / (height * height)) * 10000
//                    val formattedBmi = "%.0f".format(bmi)
//
//                    authViewModel.saveUserData(weight, height, age, 1, formattedBmi)
//
//                    navController.navigate("result_bmi/$formattedBmi")
